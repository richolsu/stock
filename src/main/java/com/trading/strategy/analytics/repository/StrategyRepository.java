...
public interface StrategyRepository extends JpaRepository<Strategy, Long> {
	@Query(value = "SELECT a.high, a.low, a.volume, a.startMs, a.count, round(b.importance*100, 2) importance FROM OHLC a left join strategy b on a.exchange=b.exchange and a.symbol=b.symbol and a.granularityInMs=b.granularityInMs and a.startMs=b.startMs and b.strategyName= :strategy "
